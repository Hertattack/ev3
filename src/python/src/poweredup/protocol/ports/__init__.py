...
from .port_mode import PortModeMapping
...
class PortModeInformationFormat:
    ...
    def parse_bytes(cls, message_bytes: bytes):
        ...
        match mode_information_type.value:
            ...
            case PortModeInformationMapping.MODE_INFORMATION_TYPE.value:
                return PortModeInformationMapping.parse_bytes(mode, message_bytes[2:])
